...
class CDMMD5 {
  public:
    ...
    inline void MD5Format(unsigned char format[33]) {
        ...
        for (unsigned char* p = digest; p < digest + sizeof(digest); ++p, i++) {
            format[i * 2] = Value2Hexdig((*p >> 4) & 0xf);
    ...
    static inline std::string Binary2Hex(unsigned char* buf, unsigned int len) {
        std::string s;
  ...
  private:
    ...
    inline void MD5_memcpy (unsigned char* output, unsigned char* input,
                            unsigned int len) {
        unsigned int i;
    ...
    inline void Encode (unsigned char* output, unsigned long int* input,
                        unsigned int len) {
        unsigned int i, j;
    ...
    inline void Decode (unsigned long int* output, unsigned char* input,
                        unsigned int len) {
        unsigned int i, j;
